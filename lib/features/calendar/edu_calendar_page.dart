...
class _EduCalendarPageState extends State<EduCalendarPage> {
  ...
  List<EduEvent> _eventsOf(DateTime day) {
    bool sameDay(DateTime a, DateTime b) =>
        a.year == b.year && a.month == b.month && a.day == b.day;

    return DummyData.eduEvents
        .where((e) => sameDay(e.startAt, day))
        .toList()
  ...
  Widget build(BuildContext context) {
    ...
    final events = _eventsOf(selected);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('$time  •  ${event.location}', style: const TextStyle(color: Colors.black54)),
                const SizedBox(height: 6),
